export const coinList = {
  ...
  AVAX: {
    ...
    summary:
      "Avalanche is a decentralized platform that enables the creation of custom blockchains. It is a platform that allows developers to create their own blockchains, which can be used to create decentralized applications. The platform is designed to be highly scalable and secure, and is based on the Proof-of-Stake consensus algorithm.",
    website: "https://www.avalabs.org/",
  ...
  BNB: {
    ...
    summary:
      "Binance Coin is the cryptocurrency used to pay fees on the Binance cryptocurrency exchange. It is an ERC-20 token that is issued by the Binance blockchain platform. Binance Coin is the native token of the Binance Chain, a blockchain that is designed to support the Binance DEX.",
    website: "https://www.binance.com/en",
  ...
  DASH: {
    ...
    summary:
      "Dash is a cryptocurrency that aims to offer financial privacy to its users. It is a fork of Bitcoin and uses the same blockchain technology. Dash uses a decentralized governance and budgeting system to make decisions for the future development of the cryptocurrency.",
    website: "https://www.dash.org/",
  ...
  DOT: {
    ...
    summary:
      "Polkadot is a decentralized network that allows different blockchains to communicate with each other. It is a protocol that allows the creation of parachains, which are blockchains that can be connected to the Polkadot network. The Polkadot network is designed to be highly scalable and secure, and is based on the Proof-of-Stake consensus algorithm.",
    website: "https://polkadot.network/",
  ...
  EOS: {
    ...
    summary:
      "EOS is a decentralized operating system that is designed to support the development of decentralized applications. It is a blockchain-based platform that allows developers to create decentralized applications that can be used to create smart contracts. The EOS network is designed to be highly scalable and secure, and is based on the Proof-of-Stake consensus algorithm.",
    website: "https://eos.io/",
  ...
  MATIC: {
    ...
    summary:
      "Polygon is a protocol and a framework for building and connecting Ethereum-compatible blockchain networks. It is a scaling solution for Ethereum that uses a sidechain architecture. Polygon is based on the Proof-of-Stake consensus algorithm.",
    website: "https://polygon.technology/",
  ...
  SOL: {
    ...
    summary:
      "Solana is a decentralized blockchain network that is designed to be highly scalable and secure. It is a Proof-of-Stake blockchain that uses a novel consensus algorithm called Proof-of-History. Solana is designed to be a platform for decentralized applications and smart contracts.",
    website: "https://solana.com/",
